...
- [x] Branch created from the recorded `main` baseline.
- [x] Temporary patch automation removed.
- [x] Encoded payload artifacts removed.
- [x] Dependency lockfile generated.
